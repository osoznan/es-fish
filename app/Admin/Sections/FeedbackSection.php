...
class FeedbackSection extends Section implements Initializable
{
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::link('name', 'Name', 'text')
            ...
            AdminColumn::boolean('answer', 'Answer'),
    ...
    public function onEdit($id = null, $payload = [])
    {
        $form = AdminForm::card()->addBody([
            AdminFormElement::columns()->addColumn([
                ...
                AdminFormElement::text('product.name', 'Product')->setReadonly(true),
                AdminFormElement::html('<hr>'),
                AdminFormElement::checkbox('hidden', 'Hidden'),
                AdminFormElement::datetime('created_at', 'Created At')->setReadonly(true),
                AdminFormElement::datetime('answer_created_at', 'Answer Created At'),
